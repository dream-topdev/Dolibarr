...
/**
 * \file    test/functional/MyApprovalFlowFunctionalTest.php
...
/**
 * Class MyApprovalFlowFunctionalTest
 *
 ...
 *
 * @package Testmyapprovalflow
 */
class MyApprovalFlowFunctionalTest extends \PHPUnit_Extensions_Selenium2TestCase
{
	...
	public function testModuleEnabled()
	{
		...
		if (strstr($module_status_image->attribute('src'), 'switch_off.png')) {
			// Enable the module
			$this->byHref('modMyApprovalFlow')->click();
		} else {
			// Disable the module
			$this->byHref('modMyApprovalFlow')->click();
			// Reenable the module
	...
	{
		$this->url('/custom/myapprovalflow/admin/setup.php');
		$this->authenticate();
		return $this->assertContains('myapprovalflow/admin/setup.php', $this->url(), 'Configuration page');
	}
	...
	{
		$this->url('/custom/myapprovalflow/admin/about.php');
		$this->authenticate();
		return $this->assertContains('myapprovalflow/admin/about.php', $this->url(), 'About page');
	}
	...
	public function testBoxDeclared()
	{
		...
		$this->authenticate();
		return $this->assertContains('myapprovalflowwidget1', $this->source(), "Box enabled");
	}
	...
	public function testTriggerDeclared()
	{
        ...
        return $this->assertContains(
			'interface_99_modMyApprovalFlow_MyApprovalFlowTriggers.class.php',
	...
	public function testTriggerEnabled()
	{
        ...
        return $this->assertContains(
			'tick.png',
			$this->byXPath('//td[text()="interface_99_modMyApprovalFlow_MyTrigger.class.php"]/following::img')->attribute('src'),
			"Trigger enabled"
		);
	}
