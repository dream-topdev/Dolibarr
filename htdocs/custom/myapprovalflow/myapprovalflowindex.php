...
/**
 *	\file       myapprovalflow/myapprovalflowindex.php
 *	\ingroup    myapprovalflow
 *	\brief      Home page of myapprovalflow top menu
 */
...
$langs->loadLangs(array("myapprovalflow@myapprovalflow"));

$action=GETPOST('action', 'alpha');


// Security check
//if (! $user->rights->myapprovalflow->myobject->read) accessforbidden();
...
llxHeader("", $langs->trans("MyApprovalFlowArea"));

print load_fiche_titre($langs->trans("MyApprovalFlowArea"), '', 'myapprovalflow.png@myapprovalflow');
...
// Draft MyObject
if (! empty($conf->myapprovalflow->enabled) && $user->rights->myapprovalflow->read)
{
	$langs->load("orders");
