...
/**
 *	\file       flow_director/flow_directorindex.php
 *	\ingroup    flow_director
 *	\brief      Home page of flow_director top menu
 */
...
$langs->loadLangs(array("flow_director@flow_director"));

$action=GETPOST('action', 'alpha');


// Security check
//if (! $user->rights->flow_director->myobject->read) accessforbidden();
...
llxHeader("", $langs->trans("Flow_directorArea"));

print load_fiche_titre($langs->trans("Flow_directorArea"), '', 'flow_director.png@flow_director');
...
// Draft MyObject
if (! empty($conf->flow_director->enabled) && $user->rights->flow_director->read)
{
	$langs->load("orders");
