...
/**
 * \file    test/functional/Flow_directorFunctionalTest.php
...
/**
 * Class Flow_directorFunctionalTest
 *
 ...
 *
 * @package Testflow_director
 */
class Flow_directorFunctionalTest extends \PHPUnit_Extensions_Selenium2TestCase
{
	...
	public function testModuleEnabled()
	{
		...
		if (strstr($module_status_image->attribute('src'), 'switch_off.png')) {
			// Enable the module
			$this->byHref('modFlow_director')->click();
		} else {
			// Disable the module
			$this->byHref('modFlow_director')->click();
			// Reenable the module
	...
	{
		$this->url('/custom/flow_director/admin/setup.php');
		$this->authenticate();
		return $this->assertContains('flow_director/admin/setup.php', $this->url(), 'Configuration page');
	}
	...
	{
		$this->url('/custom/flow_director/admin/about.php');
		$this->authenticate();
		return $this->assertContains('flow_director/admin/about.php', $this->url(), 'About page');
	}
	...
	public function testBoxDeclared()
	{
		...
		$this->authenticate();
		return $this->assertContains('flow_directorwidget1', $this->source(), "Box enabled");
	}
	...
	public function testTriggerDeclared()
	{
        ...
        return $this->assertContains(
			'interface_99_modFlow_director_Flow_directorTriggers.class.php',
	...
	public function testTriggerEnabled()
	{
        ...
        return $this->assertContains(
			'tick.png',
			$this->byXPath('//td[text()="interface_99_modFlow_director_MyTrigger.class.php"]/following::img')->attribute('src'),
			"Trigger enabled"
		);
	}
